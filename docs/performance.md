...
```text
model_frames=3200
model_total_ms=898.610
model_ms_per_frame=0.280816
model_realtime_budget_ms=4.000000
model_realtime_ratio=0.070204
dsp_hops=400
dsp_total_ms=980.084
dsp_ms_per_hop=2.450210
dsp_realtime_budget_ms=4.000000
dsp_realtime_ratio=0.612552
...
- The Q15 streaming model reference is about 0.28 ms per 4 ms frame on this host.
- The full realtime DSP reference is about 2.45 ms per 4 ms hop on this host.
...
- `rfft_naive` -> CMSIS-DSP RFFT.
- `irfft_naive` -> CMSIS-DSP inverse RFFT.
