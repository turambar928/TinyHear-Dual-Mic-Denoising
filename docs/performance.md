...
```text
model_frames=3200
model_total_ms=777.708
model_ms_per_frame=0.243034
model_realtime_budget_ms=4.000000
model_realtime_ratio=0.060758
dsp_hops=400
dsp_total_ms=968.807
dsp_ms_per_hop=2.422017
dsp_realtime_budget_ms=4.000000
dsp_realtime_ratio=0.605504
...
- The Q15 streaming model reference is about 0.24 ms per 4 ms frame on this host.
- The full realtime DSP reference is about 2.42 ms per 4 ms hop on this host.
...
See `docs/cmsis_porting.md` for the optional CMSIS-DSP backend build shape.
