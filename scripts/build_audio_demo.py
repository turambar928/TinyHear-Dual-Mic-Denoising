...
DEFAULT_SETS = [
    ...
    ("mwf_cov_student_92k", Path("runs/arctic_demand_mwf_cov_student/listening_eval")),
    ...
    ("c116_psm_noise_loss_m1.50", Path("runs/arctic_demand_spatial_c116_psm_noise_loss/listening_eval_gate_m1.50")),
